			...
			<ReactLenis root>
				<section className="bg-[#030303] h-screen flex flex-row items-center justify-between overflow-hidden" id="hero">
					<div className="pl-64 z-20">
						...
						<p className="text-lg text-zinc-200 mt-6">Advanced algorithmic trading solutions powered by artificial intelligence for <br /> institutional and retail investors.</p>
						<button className="btn btn-soft bg-zinc-700 hover:bg-zinc-500 border-0 mt-4">Get Started</button>
					</div>
					<div className="w-3/4 h-screen z-10 absolute top-0 right-0 pointer-events-none" id="gradient-overlay"></div>
					<div className="flex flex-row gap-8">
						<div ref={leftColumnRef} className="flex flex-col gap-8 translate-y-32">
							<img src="cards/1.svg" className="w-96 grayscale hover:grayscale-0 transition-all duration-300" alt="" />
							<img src="cards/2.svg" className="w-96 grayscale hover:grayscale-0 transition-all duration-300" alt="" />
							<img src="cards/3.svg" className="w-96 grayscale hover:grayscale-0 transition-all duration-300" alt="" />
						</div>
						<div ref={rightColumnRef} className="flex flex-col gap-8">
							<img src="cards/4.svg" className="w-96 grayscale hover:grayscale-0 transition-all duration-300" alt="" />
							<img src="cards/5.svg" className="w-96 grayscale hover:grayscale-0 transition-all duration-300" alt="" />
							<img src="cards/6.svg" className="w-96 grayscale hover:grayscale-0 transition-all duration-300" alt="" />
						</div>
					</div>
				</section>
				...
				<section className="py-16 px-64 bg-[#141416] flex flex-col items-center justify-center" id="why">
					...
					<div className="grid grid-cols-4 gap-16 py-8">
				...
				<section className="py-16 px-64 bg-[#141416] flex flex-col items-center justify-center" id="why">
					<h3 className="text-md text-blue-400 text-center uppercase font-medium tracking-widest">Testimonials</h3>
					<h2 className="text-3xl font-bold text-center">See what our customers think</h2>
				</section>
			</ReactLenis>
		</>
	)
