    ...
    return (
        <section className="bg-[#030303] h-screen flex flex-col md:flex-row items-center justify-between overflow-hidden" id="hero" role="banner">
            <div className="px-6 md:pl-16 w-full md:w-1/2 z-20 mt-24 md:mt-16 text-center md:text-left">
                ...
                <p className="text-base md:text-lg text-zinc-200 mt-2">Harness the power of artificial intelligence to gain an unmatched edge in trading by utilising real-time analysis of news, trends and market movements.</p>
                <button className="btn btn-soft bg-zinc-700 hover:bg-zinc-500 border-0 mt-4" aria-label="Get Started">Get Started</button>
            </div>
